...
import "./style-lm-false.css"

//DOM ELEMENTS

const productName = document.querySelector(".lm-f-product-name");
const resultDescrip = document.querySelector(".lm-f-result-description");
const exists = document.querySelector(".lm-f-exists");
const btnBack = document.querySelector(".lm-f-btn-back-to-game");
